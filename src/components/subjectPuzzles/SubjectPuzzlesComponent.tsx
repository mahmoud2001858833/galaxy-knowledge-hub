...
import { Puzzle } from '../shared/types/puzzleTypes';
  ...
  const fetchPuzzles = async () => {
    ...
    try {
      ...
      const typedPuzzles: Puzzle[] = data?.map(item => ({
        ...item,
        difficulty: item.difficulty as 'easy' | 'medium' | 'hard' | string
      })) || [];
    ...
    <div>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div className="flex flex-col items-end">
          <h2 className="text-2xl font-bold text-white">ألغاز {subjectDisplayNames[selectedSubject]}</h2>
          {userProfile && (
        ...
        <div className="flex items-center space-x-2 rtl:space-x-reverse">
          ...
          >
            <TabsList className="bg-white/10">
              <TabsTrigger 
                value="mathematics"
                className="data-[state=active]:bg-subject-math-primary"
              >
                الرياضيات
              </TabsTrigger>
              <TabsTrigger 
                value="physics"
                className="data-[state=active]:bg-subject-physics-primary"
              >
                الفيزياء
              </TabsTrigger>
              <TabsTrigger 
                value="chemistry"
                className="data-[state=active]:bg-subject-chemistry-primary"
              >
                الكيمياء
              </TabsTrigger>
              <TabsTrigger 
                value="biology"
                className="data-[state=active]:bg-subject-biology-primary"
              >
                الأحياء
              </TabsTrigger>
            </TabsList>
          ...
          {isAdmin ? (
            <div className="z-30">
              <SubjectPuzzleAdmin subject={selectedSubject} onSuccess={() => fetchPuzzles()} />
            </div>
          ) : (
            <Button 
