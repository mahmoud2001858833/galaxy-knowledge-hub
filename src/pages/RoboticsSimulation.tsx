      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          <InfoSection
            ...
            explanation="الروبوتات تعتمد على المستشعرات لاستكشاف البيئة واتخاذ القرارات. خوارزمية متابعة الجدار (Wall Follower) من أبسط خوارزميات التنقل في المتاهات."
            formulas={[
              { name: 'المسافة المقطوعة', formula: 'd = عدد الخطوات × حجم الخلية', description: 'المسافة الإجمالية' },
              { name: 'مستشعر المسافة', formula: 'd = v × t / 2', description: 'v = سرعة الصوت، t = زمن الارتداد' },
              { name: 'الكفاءة', formula: 'η = أقصر مسار / المسار الفعلي', description: 'مقياس جودة الخوارزمية' },
            ]}
            facts={[
              'أول روبوت صناعي (Unimate) استُخدم عام 1961 في مصنع جنرال موتورز',
              'كلمة "روبوت" مشتقة من الكلمة التشيكية robota بمعنى العمل القسري',
              'مركبة كيوريوسيتي على المريخ تستخدم خوارزميات تنقل ذاتية متقدمة',
              'الخوارزميات الجينية تُستخدم لتطوير سلوك الروبوتات عبر المحاكاة التطورية',
            ]}
          />
          <QuizSection questions={[
            { question: 'ما أول خطوة في خوارزمية متابعة الجدار؟', options: ['التقدم', 'الدوران يميناً', 'فحص المستشعرات', 'التراجع'], correctIndex: 2, explanation: 'يجب فحص المستشعرات أولاً لمعرفة وضع العوائق المحيطة قبل اتخاذ أي قرار حركة' },
            { question: 'ما نوع المستشعر الذي يقيس المسافة؟', options: ['حراري', 'فوق صوتي', 'ضوئي', 'مغناطيسي'], correctIndex: 1, explanation: 'المستشعر فوق الصوتي يُرسل موجات صوتية ويقيس زمن ارتدادها لحساب المسافة' },
            { question: 'ما الفرق بين الوضع اليدوي والتلقائي؟', options: ['السرعة فقط', 'مصدر القرار', 'عدد المستشعرات', 'حجم الروبوت'], correctIndex: 1, explanation: 'في اليدوي يتخذ المستخدم القرارات، وفي التلقائي تتخذ الخوارزمية القرارات بناءً على المستشعرات' },
            { question: 'أي خوارزمية تضمن إيجاد المخرج في متاهة بسيطة؟', options: ['البحث العشوائي', 'متابعة الجدار', 'التقدم المستمر', 'الدوران فقط'], correctIndex: 1, explanation: 'خوارزمية متابعة الجدار (اليد اليمنى) تضمن الوصول للمخرج في المتاهات المتصلة ببساطة' },
            { question: 'ما وحدة قياس المستشعر فوق الصوتي؟', options: ['درجة مئوية', 'سنتيمتر', 'فولت', 'هرتز'], correctIndex: 1, explanation: 'يقيس المسافة بالسنتيمتر عبر حساب: المسافة = سرعة الصوت × الزمن ÷ 2' },
          ]} />
        </div>
      </div>
    </SimulationLayout>
