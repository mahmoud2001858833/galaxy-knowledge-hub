...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden" dir="rtl">
      ...
      <motion.div 
        className="absolute top-[10%] left-[10%] w-32 h-32 bg-space-deep-purple/30 rounded-full blur-3xl"
        animate={{ 
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.6, 0.3],
        }}
      ...
      <motion.div 
        className="absolute top-[40%] right-[15%] w-40 h-40 bg-space-neon-blue/20 rounded-full blur-3xl"
        animate={{ 
          scale: [1, 1.3, 1],
          opacity: [0.2, 0.5, 0.2],
        }}
        ...
        >
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-white/10">
            <div className="flex justify-center mb-6">
              <motion.h1 
                className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-space-neon-blue to-space-vivid-purple flex items-center"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <form onSubmit={isSignUp ? handleSignUp : handleSignIn}>
              <div className="space-y-4">
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-space-deep-purple hover:bg-space-deep-purple/80 text-white"
                >
                  {loading ? (
            ...
            <Button
              ...
              disabled={loading}
              className="w-full mt-3 border-white/20 bg-[#1877F2] hover:bg-[#1877F2]/90 text-white font-medium flex items-center justify-center gap-2"
            >
