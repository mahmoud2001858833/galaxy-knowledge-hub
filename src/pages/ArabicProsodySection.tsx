...
const ArabicProsodySection = () => {
  const navigate = useNavigate();
  const floatingChars = ['ا', 'ل', 'ع', 'ر', 'و', 'ض'];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-neutral-900 to-stone-900 text-right relative overflow-hidden" dir="rtl">
      ...
      <main className="container mx-auto px-4 py-12 relative z-10">
        ...
        >
          ...
          >
            <motion.h1 
              className="text-5xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 via-teal-300 to-emerald-500"
              initial={{ scale: 0.9 }}
              animate={{ scale: 1 }}
            ...
            >
              تعلم أوزان الشعر العربي وبحوره
            </motion.p>
          </motion.div>
...
export default ArabicProsodySection;
