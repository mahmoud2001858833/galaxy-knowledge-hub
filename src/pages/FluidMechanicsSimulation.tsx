...
const FluidMechanicsSimulation = () => {
  ...
  const formulas = [
    { name: 'قانون أرخميدس', formula: 'Fb = ρf × Vf × g' },
    { name: 'قانون باسكال', formula: 'P₁ = P₂ (F₁/A₁ = F₂/A₂)' },
    { name: 'معادلة برنولي', formula: 'P + ½ρv² + ρgh = const' },
    { name: 'معادلة الاستمرارية', formula: 'A₁v₁ = A₂v₂' },
  ];

  const quizQuestions = [
    { question: 'ماذا يحدث للجسم إذا كانت كثافته أقل من كثافة السائل؟', options: ['يطفو', 'يغرق', 'يبقى معلقاً', 'يتبخر'], correctIndex: 0 },
    { question: 'حسب معادلة برنولي، عندما تزداد سرعة المائع:', options: ['ينقص الضغط', 'يزداد الضغط', 'يبقى الضغط ثابتاً', 'يتوقف التدفق'], correctIndex: 0 },
    { question: 'ما هو تطبيق عملي لقانون باسكال؟', options: ['المكبس الهيدروليكي', 'المحرك الحراري', 'المولد الكهربائي', 'العدسة المكبرة'], correctIndex: 0 },
  ];
