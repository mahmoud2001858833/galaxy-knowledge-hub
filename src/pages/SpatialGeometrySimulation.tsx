      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          ...
          <InfoSection
            ...
            formulas={[
              { name: 'حجم المكعب', formula: 'V = a³' },
              { name: 'حجم الكرة', formula: 'V = 4/3 πr³' },
              { name: 'حجم الأسطوانة', formula: 'V = πr²h' },
            ]}
            facts={['الكرة هي الشكل الذي يحتوي أكبر حجم بالنسبة لمساحة سطحه', 'الأهرامات المصرية مبنية بزاوية 51.8 درجة']}
          />
          <QuizSection questions={[
            { question: 'ما حجم مكعب طول ضلعه 3؟', options: ['9', '27', '18', '12'], correctIndex: 1, explanation: 'V = 3³ = 27' },
            { question: 'كم وجه للهرم رباعي القاعدة؟', options: ['3', '4', '5', '6'], correctIndex: 2, explanation: '4 أوجه مثلثة + القاعدة = 5' },
          ]} />
        </div>
      </div>
    </SimulationLayout>
