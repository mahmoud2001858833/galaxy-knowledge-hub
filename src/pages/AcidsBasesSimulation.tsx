...
const AcidsBasesSimulation = () => {
  ...
  const quizQuestions = [
    ...
    { question: 'ماذا ينتج عن تفاعل حمض قوي مع قاعدة قوية؟', options: ['ملح + ماء', 'غاز + ملح', 'حمض أقوى', 'لا يحدث تفاعل'], correctIndex: 0, explanation: 'تفاعل التعادل بين حمض قوي وقاعدة قوية ينتج ملحاً متعادلاً وماء: HCl + NaOH → NaCl + H₂O' },
    { question: 'ما الفرق بين الحمض القوي والضعيف؟', options: ['درجة التأين في الماء', 'اللون', 'الرائحة', 'الكثافة'], correctIndex: 0, explanation: 'الحمض القوي يتأين بالكامل في الماء بينما الحمض الضعيف يتأين جزئياً فقط.' },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          <InfoSection
            ...
            explanation="الأحماض مواد تتبرع بأيونات H⁺ والقواعد تستقبلها (تعريف برونستد-لوري). مقياس pH يقيس تركيز أيونات الهيدروجين في المحلول من 0 (حمضي جداً) إلى 14 (قاعدي جداً)."
            facts={[
              'دم الإنسان محلول منظم يحافظ على pH ≈ 7.4',
              'المطر الحمضي له pH أقل من 5.6 بسبب SO₂ وNO₂',
              'حمض المعدة (HCl) له pH حوالي 1.5 ويساعد في هضم البروتين',
              'البطارية الرصاصية تحتوي حمض الكبريتيك المركز',
            ]}
          />
