...
const Physics = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col text-right" dir="rtl">
      ...
      {/* Floating Physics Symbols */}
      {physicsSymbols.map((symbol, index) => (
        <div 
          key={index}
          className={`absolute text-blue-500/30 ${symbol.size} math-symbol pointer-events-none`}
          style={{ 
            top: symbol.top, 
            left: symbol.left, 
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-white to-cyan-500">
            منصة الفيزياء
          </h1>
