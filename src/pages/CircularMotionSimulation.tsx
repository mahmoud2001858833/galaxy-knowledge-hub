...
const CircularMotionSimulation = () => {
  ...
  const formulas = [
    { name: 'القوة المركزية', formula: 'Fc = mv²/r = mω²r', description: 'القوة اللازمة لإبقاء الجسم في مسار دائري' },
    { name: 'السرعة الخطية', formula: 'v = ωr', description: 'العلاقة بين السرعة الخطية والزاوية' },
    { name: 'الدور', formula: 'T = 2π/ω', description: 'الزمن اللازم لإكمال دورة كاملة' },
    { name: 'السرعة المدارية', formula: 'v = √(GM/r)', description: 'سرعة جسم يدور حول جسم آخر بفعل الجاذبية' },
  ];

  const quizQuestions = [
    { question: 'ما اتجاه التسارع المركزي؟', options: ['نحو المركز', 'بعيداً عن المركز', 'مماسي للمسار', 'عمودي على المستوى'], correctIndex: 0, explanation: 'التسارع المركزي يتجه دائماً نحو مركز الدائرة وهو المسؤول عن تغيير اتجاه السرعة.' },
    { question: 'إذا تضاعف نصف القطر مع بقاء السرعة الزاوية ثابتة:', options: ['تتضاعف القوة المركزية', 'تنقص القوة للنصف', 'تبقى ثابتة', 'تتضاعف أربع مرات'], correctIndex: 0, explanation: 'القوة المركزية Fc = mω²r، فعند ثبات ω ومضاعفة r تتضاعف القوة.' },
    { question: 'في الحركة الدائرية غير المنتظمة:', options: ['السرعة تتغير مع الموقع', 'السرعة ثابتة', 'لا توجد قوة مركزية', 'التسارع صفر'], correctIndex: 0, explanation: 'في الحركة غير المنتظمة يوجد تسارع مماسي بالإضافة للمركزي مما يغير مقدار السرعة.' },
    { question: 'ما نوع القوة التي تبقي القمر في مداره حول الأرض؟', options: ['الجاذبية', 'الكهرومغناطيسية', 'النووية', 'الطاردة المركزية'], correctIndex: 0, explanation: 'قوة الجاذبية بين الأرض والقمر تعمل كقوة مركزية تبقي القمر في مداره.' },
    { question: 'ماذا يحدث لجسم يدور في مسار دائري إذا انقطع الحبل؟', options: ['يتحرك في خط مستقيم مماسي', 'يطير للخارج شعاعياً', 'يتوقف', 'يسقط للمركز'], correctIndex: 0, explanation: 'عند انقطاع القوة المركزية، يتحرك الجسم في خط مستقيم مماسي لمساره الدائري حسب قانون نيوتن الأول.' },
  ];
  ...
  return (
    <SimulationLayout title="الحركة الدائرية والجاذبية" titleGradient="from-violet-400 to-purple-400" backgroundGradient="from-slate-900 via-violet-900/30 to-slate-900">
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        <InfoSection
          formulas={formulas}
          explanation="الحركة الدائرية تحدث عندما يتحرك جسم في مسار دائري بتأثير قوة مركزية. الجاذبية هي القوة المركزية التي تبقي الكواكب والأقمار في مداراتها."
          facts={[
            'محطة الفضاء الدولية تدور حول الأرض بسرعة 28000 كم/ساعة',
            'القمر يبتعد عن الأرض 3.8 سم كل سنة',
            'الأقمار الصناعية المتزامنة (GEO) تدور بنفس سرعة دوران الأرض',
            'قوة الطرد المركزي ليست قوة حقيقية بل قوة ظاهرية في إطار مرجعي دوار',
          ]}
        />
