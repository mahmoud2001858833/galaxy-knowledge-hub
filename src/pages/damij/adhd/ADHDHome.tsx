...
const MODULES = [
  {
    ...
    icon: ListChecks,
    title: 'الفحص بالاستبيان',
    description: 'استبيانات معتمدة بسؤال/شاشة مع نتيجة بصرية وتقرير AI.',
  ...
  },
  {
    to: '/damij/adhd/games',
    icon: Activity,
    title: 'التشخيص باللعب',
    description: 'بطارية 6 ألعاب تقيس الانتباه والتحكم والذاكرة وتولّد تقريراً موحّداً.',
    accent: 'from-violet-500 to-fuchsia-500',
    badge: 'Game-Based',
  },
  {
    to: '/damij/adhd/program/setup',
    icon: Brain,
    title: 'البرنامج العلاجي',
    description: 'خطة يومية مولّدة بالـ AI، ألعاب علاجية مع تتبّع كامل وتقارير يومية.',
  ...
  },
  {
    ...
    description: 'CPT, N-Back, Stroop, Go/No-Go — اختبارات أداء فعلية.',
  ...
  },
  {
    ...
    icon: ShieldCheck,
    title: 'التدخلات السلوكية',
    description: 'Token Economy، تكييفات صفّية، ومولّد جداول مرئية.',
  ...
  },
  {
    ...
    icon: BookMarked,
    title: 'مكتبة المصادر',
    description: 'مراجع موثّقة من APA و NICHQ و WHO و NICE و CHADD.',
...
const ADHDHome: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    if (cached) setActiveProgramId(cached);
  }, []);
  return (
