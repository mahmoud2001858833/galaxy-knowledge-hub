      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          ...
          <InfoSection
            ...
            formulas={[
              { name: 'المتوسط', formula: 'μ = Σx / n' },
              { name: 'الاحتمال', formula: 'P(A) = n(A) / n(S)' },
            ]}
            facts={['قانون الأعداد الكبيرة: كلما زادت التجارب اقترب المتوسط من القيمة المتوقعة', 'احتمال الحصول على 6 في رمي النرد = 1/6 ≈ 16.67%']}
          />
          <QuizSection questions={[
            { question: 'ما احتمال الحصول على صورة عند رمي عملة؟', options: ['1/4', '1/2', '1/3', '1/6'], correctIndex: 1, explanation: 'احتمال = عدد النتائج المرغوبة / الإجمالي = 1/2' },
            { question: 'ما المتوسط المتوقع لرمي نرد؟', options: ['3', '3.5', '4', '2.5'], correctIndex: 1, explanation: 'المتوسط = (1+2+3+4+5+6)/6 = 3.5' },
          ]} />
        </div>
      </div>
    </SimulationLayout>
