...
const ThermodynamicsSimulation = () => {
  ...
  const formulas = [
    { name: 'قانون الغاز المثالي', formula: 'PV = nRT', description: 'العلاقة بين الضغط والحجم ودرجة الحرارة وعدد المولات' },
    { name: 'كفاءة كارنو', formula: 'η = 1 - Tc/Th', description: 'أقصى كفاءة ممكنة لمحرك حراري' },
    { name: 'الطاقة الحركية', formula: 'KE = 3/2 kBT', description: 'متوسط الطاقة الحركية لجزيء غاز' },
    { name: 'القانون الأول', formula: 'ΔU = Q - W', description: 'الطاقة لا تفنى ولا تستحدث' },
  ];

  const quizQuestions = [
    { question: 'ما هي وحدة قياس درجة الحرارة في النظام الدولي؟', options: ['كلفن', 'سلسيوس', 'فهرنهايت', 'رانكن'], correctIndex: 0, explanation: 'الكلفن هي وحدة القياس الأساسية لدرجة الحرارة في النظام الدولي SI وتبدأ من الصفر المطلق.' },
    { question: 'ماذا يحدث لضغط الغاز عند زيادة الحرارة مع ثبات الحجم؟', options: ['يزداد', 'ينقص', 'يبقى ثابتاً', 'ينعدم'], correctIndex: 0, explanation: 'حسب قانون جاي-لوساك، الضغط يتناسب طردياً مع درجة الحرارة عند ثبات الحجم.' },
    { question: 'ما هي العملية التي لا يتم فيها تبادل حرارة مع المحيط؟', options: ['أديباتية', 'متساوية الحرارة', 'متساوية الضغط', 'متساوية الحجم'], correctIndex: 0, explanation: 'العملية الأديباتية هي التي تتم بدون تبادل حراري مع المحيط (Q=0).' },
    { question: 'ما هو القانون الثاني للديناميكا الحرارية؟', options: ['الإنتروبيا تزداد دائماً في النظام المعزول', 'الطاقة لا تفنى', 'الضغط يتناسب مع الحجم', 'الحرارة تنتقل من البارد للساخن'], correctIndex: 0, explanation: 'القانون الثاني ينص على أن الإنتروبيا الكلية لنظام معزول تميل دائماً للزيادة.' },
    { question: 'ما هو الصفر المطلق بالسلسيوس؟', options: ['-273.15°C', '-100°C', '0°C', '-460°C'], correctIndex: 0, explanation: 'الصفر المطلق (0 كلفن) يساوي -273.15 درجة مئوية وهو أدنى درجة حرارة ممكنة نظرياً.' },
  ];
  ...
  return (
    <SimulationLayout title="الديناميكا الحرارية" titleGradient="from-orange-400 to-red-400" backgroundGradient="from-slate-900 via-red-900/30 to-slate-900">
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        <InfoSection
          formulas={formulas}
          explanation="الديناميكا الحرارية تدرس العلاقة بين الحرارة والشغل والطاقة الداخلية. تحكمها أربعة قوانين أساسية تصف كيفية انتقال الطاقة وتحولها في الأنظمة الفيزيائية."
          facts={[
            'الصفر المطلق (0 كلفن) هو أدنى درجة حرارة نظرياً ولا يمكن الوصول إليه',
            'محرك كارنو هو أكثر المحركات كفاءة نظرياً ولا يمكن تجاوز كفاءته',
            'الإنتروبيا مقياس لعدم الانتظام في النظام وتزداد دائماً في الكون',
            'الشمس تعمل بالاندماج النووي وليس بالاحتراق الكيميائي',
          ]}
        />
