...
const ExperimentsSection = () => {
  ...
  const simulations: Simulation[] = [
    ...
    { id: 'projectile-motion', title: 'حركة المقذوفات', description: 'محاكاة شاملة لحركة المقذوفات والبندول والسقوط الحر', icon: <Target className="w-7 h-7" />, color: 'from-green-500 to-teal-500', route: '/simulation/projectile-motion', features: ['زوايا مختلفة', 'البندول البسيط', 'مقاومة الهواء'], category: 'physics' },
    ...
    { id: 'rocket-science', title: 'علوم الصواريخ والفضاء', description: 'إطلاق الصواريخ والمدارات الفضائية وهبوط المركبات', icon: <Rocket className="w-7 h-7" />, color: 'from-sky-600 to-indigo-500', route: '/simulation/rocket-science', features: ['إطلاق الصاروخ', 'المدارات الفضائية', 'الهبوط'], category: 'earth-space' },
    ...
    { id: 'thermodynamics', title: 'الديناميكا الحرارية', description: 'محاكاة الغاز المثالي ومحرك كارنو وانتقال الحرارة', icon: <Flame className="w-7 h-7" />, color: 'from-orange-600 to-red-600', route: '/simulation/thermodynamics', features: ['الغاز المثالي', 'محرك كارنو', 'التوصيل والحمل والإشعاع'], category: 'physics' },
    { id: 'fluid-mechanics', title: 'الموائع وقوى الطفو', description: 'قانون أرخميدس وباسكال وبرنولي مع محاكاة تفاعلية', icon: <Droplets className="w-7 h-7" />, color: 'from-blue-500 to-cyan-500', route: '/simulation/fluid-mechanics', features: ['قانون أرخميدس', 'قانون باسكال', 'معادلة برنولي'], category: 'physics' },
    { id: 'circular-motion', title: 'الحركة الدائرية والجاذبية', description: 'حركة دائرية منتظمة وغير منتظمة ومدارات الأقمار الصناعية', icon: <Circle className="w-7 h-7" />, color: 'from-violet-500 to-purple-600', route: '/simulation/circular-motion', features: ['القوة المركزية', 'الأقمار الصناعية', 'حركة غير منتظمة'], category: 'physics' },
