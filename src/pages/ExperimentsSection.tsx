...
const ExperimentsSection = () => {
  ...
  const simulations: Simulation[] = [
    ...
    { id: 'electromagnetic-waves', title: 'الموجات الكهرومغناطيسية ثلاثية الأبعاد', description: 'مختبر 3D: تعامد المجالين E و B، سلّم الطيف الكامل، والاستقطاب مع الظاهرة الكهروضوئية', icon: <Waves className="w-7 h-7" />, color: 'from-red-500 to-purple-600', route: '/electromagnetic-waves', features: ['مشهد ثلاثي الأبعاد', 'E ⟂ B ⟂ k وطاقة الفوتون', 'قانون مالوس والكهروضوئية'], category: 'physics' },
    { id: 'nuclear-reactions', title: 'التفاعلات النووية ثلاثية الأبعاد', description: 'مختبر 3D: تفاعل متسلسل بمعامل تضاعف حيّ، بلازما اندماج مشتعلة، واضمحلال إشعاعي أسّي', icon: <Atom className="w-7 h-7" />, color: 'from-green-500 to-blue-500', route: '/nuclear-reactions', features: ['مشهد ثلاثي الأبعاد', 'الحرجية k والطاقة', 'العمر النصفي والنشاط'], category: 'physics' },
    ...
    { id: 'static-electricity', title: 'الكهرباء الساكنة ثلاثية الأبعاد', description: 'مختبر 3D: قوى كولوم بمتجهات حيّة، خطوط مجال وجهد بمجس متحرك، ومولّد فان دي غراف بشرارة حقيقية', icon: <Sparkles className="w-7 h-7" />, color: 'from-yellow-600 to-red-500', route: '/simulation/static-electricity', features: ['مشهد ثلاثي الأبعاد', 'خطوط مجال محسوبة', 'انهيار الهواء والشرارة'], category: 'physics' },
    { id: 'advanced-astronomy', title: 'الفلك المتقدم 3D', description: 'مدارات كبلر ثلاثية الأبعاد وأطوار القمر وهندسة الكسوف والخسوف', icon: <Globe className="w-7 h-7" />, color: 'from-indigo-600 to-pink-500', route: '/simulation/advanced-astronomy', features: ['مدار 3D تفاعلي', 'قوانين كبلر الثلاثة', 'كسوف كلي وحلقي', 'أطوار القمر'], category: 'earth-space' },
    { id: 'quantum-mechanics', title: 'ميكانيكا الكم 3D', description: 'تجربة الشق المزدوج والنفق الكمي والتراكب بمشهد ثلاثي الأبعاد', icon: <Atom className="w-7 h-7" />, color: 'from-pink-600 to-indigo-500', route: '/simulation/quantum-mechanics', features: ['الشق المزدوج', 'النفق الكمي', 'التراكب الكمي'], category: 'physics' },
    { id: 'analytical-chemistry', title: 'الكيمياء التحليلية 3D', description: 'مختبر تحليلي ثلاثي الأبعاد: معايرة بالسحّاحة، مطياف ضوئي، وكروماتوغرافيا', icon: <FlaskConical className="w-7 h-7" />, color: 'from-emerald-600 to-teal-500', route: '/simulation/analytical-chemistry', features: ['معايرة تفاعلية 3D', 'قانون بير-لامبرت', 'حساب Rf والفصل'], category: 'chemistry' },
    { id: 'electrochemistry', title: 'الكيمياء الكهربائية ثلاثية الأبعاد', description: 'مختبر 3D: خلية جلفانية بسريان إلكترونات حيّ، تحليل كهربائي بترسيب وفقاعات، وتآكل مع حماية كاثودية', icon: <Battery className="w-7 h-7" />, color: 'from-amber-600 to-yellow-500', route: '/simulation/electrochemistry', features: ['مشهد ثلاثي الأبعاد', 'معادلة نرنست وΔG', 'قوانين فاراداي', 'التآكل والمصعد التضحوي'], category: 'chemistry' },
    ...
    { id: 'human-body', title: 'جسم الإنسان 3D', description: 'ستة أجهزة مجسّمة: الدوري والتنفسي والعصبي والهضمي والبولي والعضلي مع علامات حيوية حيّة', icon: <Heart className="w-7 h-7" />, color: 'from-red-600 to-pink-500', route: '/simulation/human-body', features: ['قلب نابض ثلاثي الأبعاد', 'تبادل غازات ومنحنى بور', 'كلية وقُسيم عضلي'], category: 'biology' },
    ...
    { id: 'special-relativity', title: 'النسبية الخاصة ثلاثية الأبعاد', description: 'مختبر 3D: ساعتان ضوئيتان لتمدد الزمن، قضيب متقلّص، وأعمدة طاقة نسبية مع مفارقة التوأم', icon: <Clock className="w-7 h-7" />, color: 'from-yellow-500 to-orange-500', route: '/simulation/special-relativity', features: ['مشهد ثلاثي الأبعاد', 'معامل لورنتز γ', 'E = γm₀c²'], category: 'physics' },
    ...
    { id: 'chemical-kinetics', title: 'حركية التفاعلات ثلاثية الأبعاد', description: 'مختبر 3D: صندوق تصادمات حيّ، كأسا المتفاعل والناتج، ومنحنى طاقة تنشيط مجسّم', icon: <FlaskConical className="w-7 h-7" />, color: 'from-blue-500 to-cyan-500', route: '/simulation/chemical-kinetics', features: ['مشهد ثلاثي الأبعاد', 'نظرية التصادم', 'معادلة أرهينيوس', 'أثر العامل الحفّاز'], category: 'chemistry' },
    { id: 'organic-chemistry', title: 'الكيمياء العضوية ثلاثية الأبعاد', description: 'مختبر 3D: نماذج جزيئية دوّارة، مقارنة المتصاوغات، وتفاعلات عضوية متحرّكة', icon: <Hexagon className="w-7 h-7" />, color: 'from-green-500 to-emerald-500', route: '/simulation/organic-chemistry', features: ['مشهد ثلاثي الأبعاد', 'المجموعات الوظيفية', 'المتصاوغات', 'الأسترة والإحلال'], category: 'chemistry' },
    { id: 'states-of-matter', title: 'حالات المادة والتحولات ثلاثية الأبعاد', description: 'مختبر 3D: جسيمات حركية حيّة، منحنى تسخين بالحرارة الكامنة، ومخطط طور تفاعلي', icon: <Snowflake className="w-7 h-7" />, color: 'from-cyan-500 to-blue-500', route: '/simulation/states-of-matter', features: ['مشهد ثلاثي الأبعاد', 'النظرية الحركية وتوزيع السرعات', 'مخطط الطور والنقطة الحرجة'], category: 'chemistry' },
    { id: 'acids-bases', title: 'الأحماض والقواعد ثلاثية الأبعاد', description: 'مختبر 3D: مقياس pH بأيونات متحركة، معايرة بالسحّاحة مع تغيّر لون الكاشف، ومقارنة المحاليل المنظّمة بالماء النقي', icon: <FlaskRound className="w-7 h-7" />, color: 'from-yellow-500 to-red-500', route: '/simulation/acids-bases', features: ['مشهد ثلاثي الأبعاد', 'منحنى المعايرة', 'هندرسون-هاسلبالخ', 'الكواشف والسعة التنظيمية'], category: 'chemistry' },
    ...
    { id: 'living-cell', title: 'الخلية الحية 3D', description: 'خلية مجسّمة تفاعلية: عضيّات قابلة للنقر، مقارنة الأنواع، والنقل عبر الغشاء', icon: <Microscope className="w-7 h-7" />, color: 'from-emerald-500 to-teal-500', route: '/simulation/living-cell', features: ['عضيّات تفاعلية 3D', 'مقارنة حيوانية/نباتية/بكتيرية', 'الأسموزية والنقل النشط'], category: 'biology' },
    { id: 'cell-division', title: 'الانقسام الخلوي 3D', description: 'أطوار الميتوزيس والميوزيس مجسّمة مع المغزل والعبور الجيني ودورة الخلية', icon: <Scissors className="w-7 h-7" />, color: 'from-violet-500 to-fuchsia-500', route: '/simulation/cell-division', features: ['أطوار مجسّمة تفاعلية', 'العبور الجيني', 'دورة الخلية ونقاط التفتيش'], category: 'biology' },
    { id: 'photosynthesis-respiration', title: 'البناء الضوئي والتنفّس 3D', description: 'بلاستيدة وميتوكندريا مجسّمتان: فوتونات، سلسلة نقل إلكترون، ATP سينثيز دوّار، وتبادل غازات حيّ', icon: <Leaf className="w-7 h-7" />, color: 'from-green-500 to-lime-500', route: '/simulation/photosynthesis-respiration', features: ['مشهد ثلاثي الأبعاد', 'دورة كالفن وكربس', 'العوامل المحدّدة ونقطة التعويض', 'حصيلة ATP'], category: 'biology' },
