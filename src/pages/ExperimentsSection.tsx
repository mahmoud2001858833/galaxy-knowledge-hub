...
const ExperimentsSection = () => {
  ...
  const simulations: Simulation[] = [
    ...
    { id: 'electromagnetic-waves', title: 'الموجات الكهرومغناطيسية ثلاثية الأبعاد', description: 'مختبر 3D: تعامد المجالين E و B، سلّم الطيف الكامل، والاستقطاب مع الظاهرة الكهروضوئية', icon: <Waves className="w-7 h-7" />, color: 'from-red-500 to-purple-600', route: '/electromagnetic-waves', features: ['الطيف الكامل بالألوان الحقيقية', 'التحكم بالتردد والطول الموجي', 'تطبيقات عملية'], category: 'physics' },
