...
const ExperimentsSection = () => {
  ...
  const simulations: Simulation[] = [
    ...
    { id: 'cell-division', title: 'الانقسام الخلوي', is3D: true, description: 'الانقسام المتساوي والمنصف بالمراحل', icon: <Scissors className="w-7 h-7" />, color: 'from-violet-500 to-fuchsia-500', route: '/simulation/cell-division', features: ['الانقسام المتساوي', 'الانقسام المنصف', 'الكروموسومات'], category: 'biology' },
