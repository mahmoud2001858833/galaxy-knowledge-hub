...
const SpecialRelativitySimulation = () => {
  ...
  const formulas = [
    { name: 'معامل لورنتز', formula: 'γ = 1/√(1-v²/c²)' },
    { name: 'تمدد الزمن', formula: "Δt' = γΔt" },
    { name: 'تقلص الطول', formula: 'L = L₀/γ' },
    { name: 'تكافؤ الكتلة والطاقة', formula: 'E = mc²' },
  ];

  const quizQuestions = [
    { question: 'ماذا يحدث للزمن عند الاقتراب من سرعة الضوء؟', options: ['يتباطأ', 'يتسارع', 'يتوقف تماماً', 'لا يتأثر'], correctIndex: 0 },
    { question: 'ما قيمة γ عند v = 0؟', options: ['1', '0', '∞', 'غير محددة'], correctIndex: 0 },
    { question: 'كم تساوي طاقة 1 كغ من المادة بالكامل؟', options: ['9×10¹⁶ جول', '3×10⁸ جول', '1 جول', '6.02×10²³ جول'], correctIndex: 0 },
  ];
