...
const PhotosynthesisRespirationSimulation = () => {
  ...
  const quizQuestions = [
    ...
    { question: 'ما الصبغة المسؤولة عن امتصاص الضوء في النبات؟', options: ['الميلانين', 'الكلوروفيل', 'الهيموغلوبين', 'الكاروتين فقط'], correctIndex: 1, explanation: 'الكلوروفيل هو الصبغة الخضراء الرئيسية التي تمتص الضوء الأحمر والأزرق وتعكس الأخضر.' },
    { question: 'أين يحدث التنفس الخلوي؟', options: ['البلاستيدات', 'الميتوكوندريا', 'النواة', 'الغشاء الخلوي فقط'], correctIndex: 1, explanation: 'التنفس الخلوي يحدث بشكل رئيسي في الميتوكوندريا (محطة الطاقة في الخلية).' },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          <InfoSection
            ...
            explanation="البناء الضوئي يحول الطاقة الضوئية إلى طاقة كيميائية مخزنة في الجلوكوز، بينما التنفس الخلوي يحرر هذه الطاقة لاستخدامها في العمليات الحيوية."
            facts={[
              'النباتات تنتج أكثر من 50% من الأكسجين على الأرض',
              'الطحالب البحرية مسؤولة عن معظم الأكسجين الباقي',
              'بدون البناء الضوئي لن تكون هناك حياة على الأرض كما نعرفها',
              'شجرة واحدة كبيرة تنتج أكسجيناً كافياً لـ 4 أشخاص يومياً',
            ]}
          />
