...
const ImmuneSystemSimulation = () => {
  ...
  const quizQuestions = [
    ...
    { question: 'ما الفرق بين المناعة الفطرية والمكتسبة؟', options: ['الفطرية عامة والمكتسبة متخصصة', 'لا فرق', 'المكتسبة أسرع', 'الفطرية تحتاج تدريب'], correctIndex: 0, explanation: 'المناعة الفطرية استجابة عامة وسريعة، بينما المكتسبة متخصصة لمسبب مرض محدد وتكوّن ذاكرة مناعية.' },
    { question: 'ما دور خلايا الذاكرة المناعية؟', options: ['تتذكر مسببات الأمراض السابقة لاستجابة أسرع', 'تنتج الدم', 'تهضم الطعام', 'تنقل الأكسجين'], correctIndex: 0, explanation: 'خلايا الذاكرة تبقى في الجسم لسنوات وتتعرف فوراً على مسبب المرض عند التعرض له مرة أخرى.' },
  ];
