...
const JordanTawjihiArabic = () => {
  ...
  const categories = [
    { id: 'question-bank', label: 'بنك أسئلة', icon: FileQuestion, gradient: 'from-purple-600/20 to-pink-600/20', borderColor: 'border-purple-500/30', iconColor: 'text-purple-400' },
  ...
  const additionalContent = (
    ...
    >
      <Card className="bg-gradient-to-br from-rose-600/20 to-pink-600/20 border-2 border-rose-500/30 hover:shadow-xl transition-all duration-300">
        <CardHeader>
        ...
        >
          ...
          >
            <img 
              ...
              className="h-24 w-auto rounded-xl shadow-xl shadow-purple-500/50"
            />
          </motion.div>
