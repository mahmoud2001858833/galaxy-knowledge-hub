      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          ...
          <InfoSection
            ...
            formulas={[
              { name: 'الميزة الميكانيكية', formula: 'MA = Load / Effort' },
              { name: 'الرافعة', formula: 'F₁ × d₁ = F₂ × d₂' },
            ]}
            facts={['الأهرامات بُنيت باستخدام الرافعات والمنحدرات', 'التروس تُستخدم في الساعات منذ القرن الـ13']}
          />
          <QuizSection questions={[
            { question: 'ما الميزة الميكانيكية لنظام 4 بكرات؟', options: ['2', '3', '4', '8'], correctIndex: 2, explanation: 'MA = عدد البكرات = 4' },
            { question: 'أي نوع رافعة يكون المحور في المنتصف؟', options: ['الأولى', 'الثانية', 'الثالثة', 'لا يوجد'], correctIndex: 0, explanation: 'الرافعة من النوع الأول: المحور بين القوة والحمل (كالأرجوحة)' },
          ]} />
        </div>
      </div>
    </SimulationLayout>
