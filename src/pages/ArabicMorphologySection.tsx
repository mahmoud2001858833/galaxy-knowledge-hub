...
const ArabicMorphologySection = () => {
  ...
  const morphologyTools = [
    { 
      ...
      gradient: 'from-violet-900/30 via-purple-800/20 to-violet-700/30',
    ...
    { 
      ...
      gradient: 'from-fuchsia-900/30 via-pink-800/20 to-fuchsia-700/30',
      textColor: 'text-fuchsia-200',
      path: '/arabic-platform/morphology/ai'
    },
    { 
      id: 'root',
      title: 'أداة الجذور',
      ...
      gradient: 'from-purple-900/30 via-indigo-800/20 to-purple-700/30',
      textColor: 'text-purple-200',
      path: '/arabic-platform/morphology/root'
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-neutral-900 to-stone-900 text-right relative overflow-hidden" dir="rtl">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0" style={{
          backgroundImage: 'radial-gradient(circle at 20% 50%, rgba(139, 92, 246, 0.15) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(217, 70, 239, 0.15) 0%, transparent 50%)',
        }}></div>
      </div>
      ...
      <main className="container mx-auto px-4 py-12 relative z-10">
        ...
        >
          ...
          >
            <motion.h1 
              className="text-5xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-violet-400 via-purple-300 to-fuchsia-400"
              initial={{ scale: 0.9 }}
              animate={{ scale: 1 }}
            ...
            <motion.div 
              className="w-24 h-1.5 bg-gradient-to-r from-transparent via-purple-500 to-transparent mx-auto mb-6 rounded-full"
              initial={{ width: 0 }}
              animate={{ width: 96 }}
              transition={{ duration: 0.8, delay: 0.3 }}
            />
            <motion.p 
              className="text-xl md:text-2xl text-purple-100/80 max-w-3xl mx-auto font-light"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.4 }}
            >
              اختر الأداة المناسبة لتعلم وإتقان علم الصرف
            </motion.p>
          </motion.div>
          ...
          <motion.button
            ...
            className="mb-8 px-8 py-4 elegant-card rounded-xl text-purple-300 hover:text-purple-200 transition-colors flex items-center gap-3 group"
          >
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            <span className="font-semibold">رجوع</span>
          </motion.button>

          {/* Morphology Tools Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {morphologyTools.map((tool, index) => (
              ...
              >
                ...
                {/* إطار متدرج */}
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-purple-500/20 to-fuchsia-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl"></div>
                ...
                <div className="absolute inset-0 p-8 z-10 flex flex-col justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <motion.div 
                      className="mt-4 h-1 bg-gradient-to-l from-violet-500 to-fuchsia-500 rounded-full"
                      initial={{ width: 0 }}
