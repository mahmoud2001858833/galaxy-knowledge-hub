...
const videoOnly = "/tmp/damij-v5-video-only.mp4";
await renderMedia({
  composition,
  serveUrl: bundled,
  codec: "h264",
...
const bgProcessed = "/tmp/damij-v5-bg.mp3";
...
const mixed = "/tmp/damij-v5-mixed.mp3";
...
// Mux
const finalOut = "/mnt/documents/damij-zayed-video-v5.mp4";
