...
const videoOnly = "/tmp/damij-v6-video-only.mp4";
await renderMedia({
  composition,
  serveUrl: bundled,
  codec: "h264",
...
const bgProcessed = "/tmp/damij-v6-bg.mp3";
...
const mixed = "/tmp/damij-v6-mixed.mp3";
...
// Mux
const finalOut = "/mnt/documents/damij-zayed-video-v6.mp4";
