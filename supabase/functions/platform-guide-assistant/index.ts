...
- **🎯 الألغاز التعليمية**: 
  - ألغاز متنوعة في جميع المواد (فيزياء، كيمياء، أحياء، رياضيات)
  - نظام نقاط تنافسي - لكل سؤال فرصة واحدة فقط!
  - **قائمة المتصدرين**: ترتيب المستخدمين حسب النقاط مع ميداليات للأوائل
  - لوحة إدارة للمشرفين لرفع وتعديل وحذف الألغاز
