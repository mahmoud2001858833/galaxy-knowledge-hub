...
هل تريد معرفة المزيد عن شاعر معين أم تفضل استكشاف عصر أدبي محدد؟`
      ...
      responseText = `أهلاً بك في المنصة التعليمية! بما أنك مهتم باللغة العربية، دعني أرشدك إلى المنصة الأدبية العربية المحسنة.
...
- معجم تفاعلي مع البحث الفوري والذكي
...
أي قسم تريد أن تبدأ به؟`
    ...
    else if (lowerMessage.includes('معجم') || lowerMessage.includes('كلمة') || lowerMessage.includes('معنى')) {
      responseText = `ممتاز! للبحث عن الكلمات ومعانيها، أنصحك بقسم "معجم العرب الشامل المحسن".

مميزات المعجم المحسن:
✨ **البحث الفوري والذكي** - النتائج تظهر أثناء الكتابة!
🔍 البحث في آلاف الكلمات العربية
📚 شرح المعاني والتفاصيل الكاملة
🎯 تصنيف حسب فئات الكلمات (أسماء، أفعال، صفات...)
🌍 معلومات عن اللهجات والمناطق
⚖️ الأوزان الصرفية للكلمات
📖 أمثلة قرآنية وشعرية
➕ إمكانية إضافة كلمات جديدة

للوصول إليه:
1️⃣ المنصات الأدبية → منصة اللغة العربية
2️⃣ اختر "معجم العرب الشامل المحسن"

الآن يمكنك البحث عن أي كلمة بمجرد كتابة بعض الحروف!`
    }
    else {
...
**المنصات الأدبية:**
- منصة اللغة العربية المحسنة (تحتوي على: المساعد الذكي، شعراء العرب، علماء اللغة، معجم العرب المحسن، مساعد الإعراب)
- منصة اللغة الإنجليزية (قريباً)
