...
- أرجع فقط الكود داخل بلوك markdown واحد بصيغة \`\`\`${language} ... \`\`\`.
- بعد بلوك الكود اكتب شرحاً مختصراً بالعربية للخطوات الأساسية.
- إذا كان هناك كود حالي، حسّنه أو أضف الميزة المطلوبة عليه دون كسر ما يعمل.`;
